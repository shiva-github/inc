...
<div id="page" class="site">
    <a class="skip-link screen-reader-text"
       href="#content"><?php esc_html_e('Skip to content', 'business-hour') ?></a>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="header-search">
                                ...
                                <form action="<?php echo esc_url(home_url()) ?>" autocomplete="on" class="top-search">
                                    <input id="search" name="s" value="<?php echo get_search_query(); ?>" type="text" placeholder="<?php  esc_html__('search','business-hour');?>">
                    ...
                    <div class="navbar-header">
                        ...
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                            <div class="visible-xs visible-sm  clearfix"><span id="showbutton" class="clearfix"><img
                                        ...
                                        src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/button.png"
                                        alt=""/></span>
                            </div>
                        </button>
