...
if ( is_singular('chapters') && is_user_logged_in() ) {
      global $post;     // if outside the loop
      $loadpost = 0;
      $parent2 = get_post($post->ID)->parent_module;
      $parent1 = wp_get_post_parent_id($parent2);
      $parent0 = wp_get_post_parent_id($parent1);
      if($parent2) {
        $loadpost = $parent2;
      }
      if($parent1) {
      ...
      $chapter_parent_mod = get_post($loadpost);
            ...
            <div class="container">
              ...
              if (is_user_logged_in()) {
                ...
                if( is_singular('chapters') ) {
                  ?>
                  <a class="header_module" href="<?php echo get_post_permalink($chapter_parent_mod);?>"><?php echo $chapter_parent_mod->post_title; ?> </a>
                  <?php
                }
