...
function vw_gardening_landscaping_scripts() {
	...
	wp_enqueue_script( 'vw-gardening-landscaping-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );
...
function vw_gardening_landscaping_ie_stylesheet(){
	wp_enqueue_style('vw-gardening-landscaping-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-gardening-landscaping-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_gardening_landscaping_ie_stylesheet');
...
define('VW_GARDENING_LANDSCAPING_CREDIT','https://www.vwthemes.com/themes/free-gardening-wordpress-theme/','vw-gardening-landscaping');
